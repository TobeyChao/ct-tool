...
public struct Quest : IFlatbufferObject
{
  ...
  public int RewardItemId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void AddRewardItemId(FlatBufferBuilder builder, int rewardItemId) { builder.AddInt(3, rewardItemId, 0); }
  public static void AddRequiredLevel(FlatBufferBuilder builder, int requiredLevel) { builder.AddInt(4, requiredLevel, 0); }
...
static public class QuestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*RewardItemId*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 12 /*RequiredLevel*/, 4 /*int*/, 4, false)
