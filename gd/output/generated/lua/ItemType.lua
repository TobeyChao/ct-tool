...
function ItemType.Start(builder)
  builder:StartObject(3)
end

function ItemType.AddId(builder, id)
  builder:PrependInt32Slot(0, id, 0)
end

function ItemType.AddName(builder, name)
  builder:PrependUOffsetTRelativeSlot(1, name, 0)
end

function ItemType.AddCode(builder, code)
  builder:PrependUOffsetTRelativeSlot(2, code, 0)
end

function ItemType.End(builder)
