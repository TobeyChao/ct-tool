# Schema Workbench  repository-cutover baseline

This fixture freezes the last supported pre workspace before the canonical
...
Do not refresh this baseline after converting the repository to the  format;
